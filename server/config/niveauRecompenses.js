...
function getRecompensePourNiveau(niveau) {
  return RECOMPENSES_NIVEAUX.find((r) => r.niveau === niveau) || null;
}

function listeRecompenses() {
  return RECOMPENSES_NIVEAUX;
}

module.exports = { RECOMPENSES_NIVEAUX, getRecompensePourNiveau, listeRecompenses };
